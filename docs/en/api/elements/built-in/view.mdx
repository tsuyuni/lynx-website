...
<Go
  example="view"
  defaultFile="src/App.tsx"
  img="/assets/doc/view_layout.jpeg"
  highlight="{24-56}"
/>
...
It is used to specify one or more class names for an element, which can be used in CSS to apply styles.
...
<img src="/assets/doc/consume_slide_event.jpg" width="70%" height="70%" />
