...
<table>
  <tr style={{ textAlign: 'center' }}>
    <td>
      <span>Other cross-platform solutions</span>
    </td>
    <td>
      <span>Lynx</span>
    </td>
  ...
  <tr>
    <td style={{ paddingRight: '10px' }}>
      <video
        ref={function (videoRef) {
          if (videoRef) videoRef.playbackRate = 0.3;
        }}
        muted
        autoPlay
        loop
        playsInline
        controls
        src="/assets/ifr_fib_with_blank.mp4"
