...
![First Screen Direct Render Process](/assets/doc/first-render-without-network.png 'First Screen Direct Render Process')
...
![First Screen Render Process with Network Requests](/assets/doc/first-render-with-network.png 'First Screen Render Process with Network Requests')
...
![All Initialization Phase](/assets/doc/all-init-process.png 'All Initialization Phase')
