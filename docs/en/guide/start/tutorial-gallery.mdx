...
To display all your beautiful images, we will use `<list>` to help us. This way, you can get a scrollable page that can display a large number of similar images:
