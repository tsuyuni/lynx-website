...
<Info title="Lynx for Android">
  ...
  - You can refer to the project: [integrating-lynx-demo-projects](https://github.com/lynx-family/integrating-lynx-demo-projects/tree/release/1.0) for all the code mentioned below.
</Info>
...
dependencies {
    ...
    implementation "org.lynxsdk.lynx:primjs:2.11.1-alpha.2"
}
```
</Tab>
...
dependencies {
    ...
    implementation "org.lynxsdk.lynx:lynx-service-image:3.2.0-alpha.1"
    ...
    implementation "org.lynxsdk.lynx:lynx-service-log:3.2.0-alpha.1"

    // integrating http-service
    implementation "org.lynxsdk.lynx:lynx-service-http:3.2.0-alpha.1"
}
```
</CodeFold>
</Tab>
