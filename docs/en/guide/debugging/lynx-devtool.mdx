...
<video src="/assets/devtool-overview.mp4" loop autoPlay muted></video>
...
<img
  src="/assets/doc/debugging-devtool-switch-en-ios.png"
...
<img
  src="/assets/doc/debugging-using-devtool-toolbar-connection.png"
...
<img
  src="/assets/doc/debugging-using-devtool-toolbar-choose-device.png"
...
<img
  src="/assets/doc/debugging-device-menu.png"
  alt="Choose Debugging Device"
  width={140}
/>
...
<img
  src="/assets/doc/debugging-using-devtool-toolbar-card-settings.png"
...
<img
  src="/assets/doc/debugging-setting-menu.png"
...
![](/assets/doc/debugging-panel-elements.png)

The **Elements** panel allows you to inspect and modify DOM elements.

- [Lynx Page Preview Window](/guide/debugging/lynx-devtool/elements-panel#lynx-page-preview-window)
- [Viewing DOM Nodes](/guide/debugging/lynx-devtool/elements-panel#viewing-dom-nodes)
- [Changing DOM Nodes](/guide/debugging/lynx-devtool/elements-panel#changing-dom-nodes)
- [Viewing and Changing CSS](/guide/debugging/lynx-devtool/elements-panel#viewing-and-changing-css)
- [Finding Invalid, Overridden, and Other CSS](/guide/debugging/lynx-devtool/elements-panel#finding-invalid-and-overridden-and-other-css)

### Console

![](/assets/doc/debugging-panel-console.png)
...
![](/assets/doc/debugging-panel-sources.png)
...
- [Debug Original Code with Source Map](/guide/debugging/lynx-devtool/sources-panel#debug-original-code-with-source-map)
- [Debug the Main Thread](/guide/debugging/lynx-devtool/sources-panel#debug-the-main-thread)

### Layers

![](/assets/doc/debugging-panel-layers.png)
