...
<Go
  img="/assets/doc/guide-border-background-shadow.png"
  highlight="{8-12}"
  example="css"
...
<table rules="none" align="center" width="100%" style={{tableLayout:"fixed"}}>
  <tr style={{height: '275px'}}>
    <td style={{padding: '15px'}}>
      <center>
        <img src="/assets/doc/color-gradient.png" style={{width: "80%"}}/>
        <br/>
    ...
    <td style={{padding: '15px'}}>
      <center>
        <img src="/assets/doc/guide-radial-gradient.png" style={{width: "80%"}}/>
        <br/>
    ...
    <td style={{padding: '15px'}}>
      <center>
        <img src="/assets/doc/guide-fading-edge.gif" style={{width: "80%"}}/>
        <br/>
...
<Go
  img="/assets/doc/guide-clip-path.png"
  example="css"
