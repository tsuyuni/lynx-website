...
<img
  src="/assets/doc/debugging-devtool-switch-zh-ios.png"
...
<img src="/assets/doc/debugging-setting-menu.png" alt="调试选项" width={200} />
...
- [截屏窗口](/guide/debugging/lynx-devtool/elements-panel#截屏窗口)
- [查看 DOM 节点](/guide/debugging/lynx-devtool/elements-panel#查看-dom-节点)
- [更改 DOM 节点](/guide/debugging/lynx-devtool/elements-panel#更改-dom-节点)
- [查看和更改 CSS](/guide/debugging/lynx-devtool/elements-panel#查看和更改-css)
- [查找无效、已替换和其他 CSS](/guide/debugging/lynx-devtool/elements-panel#查找无效、已替换和其他-css)
