...
<Go
  ...
  img="/assets/doc/event/event_chain.gif"
...
<Go
  ...
  img="/assets/doc/event/event_capture.gif"
  highlight="{7-9,14}"
...
<Go
  ...
  img="/assets/doc/event/event_static_catch.gif"
...
<Go
  ...
  img="/assets/doc/event/event_global_bind.gif"
...
<Go
  ...
  img="/assets/doc/event/event_aop.gif"
  highlight="{7-12,65}"
  entry="src/event_aop"
/>
...
<Go
  ...
  img="/assets/doc/event/event_emitter_toggle.gif"
...
<Go
  ...
  img="/assets/doc/event/event_emitter_listen.gif"
  highlight="{7-9}"
