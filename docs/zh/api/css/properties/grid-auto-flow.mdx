...
在[网格布局](guide/ui/layout/grid-layout.mdx)中，`grid-auto-flow` 控制着自动布局算法怎样运作，精确指定在网格中被自动布局的元件怎样排列。此属性作用在网格容器上。
...
<Go
  ...
  img="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/doc/css/grid-auto-flow.png"
