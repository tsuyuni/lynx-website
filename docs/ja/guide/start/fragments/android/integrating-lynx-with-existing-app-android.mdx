...
<Info title="Lynx for Android">
  ...
  Android application development. - You can refer to the project:
  [integrating-lynx-demo-projects](https://github.com/lynx-family/integrating-lynx-demo-projects/tree/release/3.1)
  for all the code mentioned below.
</Info>
...
<center>
  <img
    src="https://lf-lynx.tiktok-cdns.com/obj/lynx-artifacts-oss-sg/lynx-website/assets/doc/hello-world-showcase-android.png"
    width="200"
  />
</center>
